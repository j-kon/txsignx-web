export function SecurityPipeline(){
  return (
    <section className="pipeline-section" aria-labelledby="pipeline-heading">
      ...
      <div className="pipeline-flow-wrapper" role="region" aria-label="Transaction security flow">
        <div className="pipeline-flow">
          ...
          <div className="pipeline-node node-wallet">
            ...
            <div className="node-meta meta-highlight">Transaction context</div>
          </div>

          {/* Connector 1: Wallet -> TxSignX */}
          ...
          {/* TxSignX Boundary Group: Stage 2 & Stage 3 */}
          <div className="pipeline-txsignx-cluster">
            <div className="cluster-header">
              <span className="cluster-badge">TxSignX Security Filter</span>
              <span className="cluster-sub">Pre-Sign Inspection & Policy</span>
            </div>

            <div className="cluster-nodes">
              {/* Stage 2: TxSignX Inspection */}
              <div className="pipeline-node node-txsignx active-boundary">
                <div className="node-badge badge-accent">Inspection Core</div>
                ...
                <h3 className="node-title">TxSignX</h3>
                <p className="node-desc">Parses inputs, outputs, fee rates, script types, and PSBT metadata.</p>
                <div className="node-meta meta-highlight">Inspect + verify</div>
              </div>

              {/* Internal Connector: TxSignX -> Policy Engine */}
              <div className="pipeline-connector internal-connector" aria-hidden="true">
                <div className="connector-line">
              ...
              <div className="pipeline-node node-policy active-boundary">
                <div className="node-badge badge-accent">Engine</div>
                ...
                <h3 className="node-title">Policy Engine</h3>
                <p className="node-desc">Evaluates 15 active deterministic security rules against verified facts.</p>
                <div className="node-meta meta-highlight">Deterministic rules</div>
              </div>
            </div>
          </div>

          {/* Connector 3: TxSignX -> Signer */}
          <div className="pipeline-connector" aria-hidden="true">
            <div className="connector-line">
          ...
          <div className="pipeline-node node-signer external-boundary">
            ...
            <h3 className="node-title">Signer</h3>
            <p className="node-desc">Receives vetted transaction proposal only after preflight policies pass.</p>
            <div className="node-meta meta-warning">External signing step</div>
          </div>
        </div>
      </div>
